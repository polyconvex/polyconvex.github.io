...
function finishScroll() {
 ...
 //  markers: true,
  ...
  // this populates the results area depending on the result
   if ($('.notstarted')[0]) { } else {
  // all the same
  if (activeitem1 === activeitem2 && activeitem2 === activeitem3) {

 textcontent.innerHTML = '<p>Voitit: ' + '<b>"' + activeitem1 + '"</b>' + ' !</p>';  
  ...
  switch (activeitem1) {
    case 'Kertoimia vastaan':
      winOutput('ZU7JPdxi1xo');
       description.innerHTML = "Tsekkaa pätkä 1.9.2023 julkaistavasta biisistä!";
      break;
    case 'Muistan':
    ...
    case 'Seppä':
      winOutput('nZUoWA5J9iA');
       description.innerHTML = "Onnittelut Seppä, taoit ittes lisäarvontaan! Laita screenshot tästä IG storyyn ja tagaa @kerrostalomusic, niin pääset kokeilemaan onneasi lisäarvonnassa!";
      break;
    case 'Hummani hei':
      winOutput('nZUoWA5J9iA');
       description.innerHTML = "Tsekkaa pätkä 1.9.2023 julkaistavasta biisistä!";
    ...
    case 'PLAYA':
      winOutput('BzlR_dR5zrQ');
       description.innerHTML = "Onnittelut PLAYA, pääsit messiin lisäarvontaan! Laita screenshot tästä IG storyyn ja tagaa @kerrostalomusic, niin pääset kokeilemaan onneasi lisäarvonnassa!";
break;
    case 'ALAX?':
      winOutput('1mTl535Q1wY');
       description.innerHTML = "ALAX olee valmis kokeilee lisäarvontaa? Laita screenshot tästä IG storyyn ja tagaa @kerrostalomusic, niin pääset kokeilemaan onneasi lisäarvonnassa!";
      break;
    case 'Maa oon se mies':
      winOutput('Q7aEpBYTdAQ');
       description.innerHTML = "Tsekkaa pätkä 1.9.2023 julkaistavasta biisistä!";
       textcontent.innerHTML = '<p>Voitit: ' + '<b>"' + 'Mää oon se mies' + '"</b>' + ' !</p>';  
      break;
    case 'Små grabbar':
  ...
  // none the same
    if (activeitem1 != activeitem2 && activeitem2 != activeitem3 && activeitem1 != activeitem3) { 
  	textcontent.innerHTML =  '<p>Ei voittoa.</p>'
    }

      if (activeitem1 === 'Jokeri' || activeitem2 === 'Jokeri' || activeitem3 === 'Jokeri') {
      textcontent.innerHTML =  '<p>Ei voittoa.</p>'
}

  // first and second the same
    if (activeitem1 === activeitem2 && activeitem1 != activeitem3 && activeitem2 != activeitem3 && activeitem1 !== 'Jokeri' ) {

if (activeitem1 === 'Maa oon se mies') {
textcontent.innerHTML = '<p>' + '<b>"Mää oon se mies"</b>' + ' on lähellä...</p>'
} else {

            textcontent.innerHTML = '<p>' + '<b>"' + activeitem1 + '"</b>' + ' on lähellä...</p>'
}            
} 
    // first and third the same
      if (activeitem1 === activeitem3 && activeitem1 != activeitem2 && activeitem3 != activeitem2 && activeitem1 !== 'Jokeri') {
...
textcontent.innerHTML = '<p>' + '<b>"Mää oon se mies"</b>' + ' on lähellä...</p>' 
    ...
    // second and third the same
      if (activeitem2 === activeitem3 && activeitem1 != activeitem3 && activeitem1 != activeitem2 && activeitem2 !== 'Jokeri') {

if (activeitem1 === 'Maa oon se mies') {
textcontent.innerHTML = '<p>' + '<b>"Mää oon se mies"</b>' + ' on lähellä...</p>'
} else {

      textcontent.innerHTML = '<p>' + '<b>"' + activeitem3 + '"</b>' + ' on lähellä...</p>'
}
}
